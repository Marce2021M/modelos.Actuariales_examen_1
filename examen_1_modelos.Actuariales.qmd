...
Una vez que tenemos el valor del fondo total, calculamos las utilidades como la diferencia entre el fondo total y el valor de la póliza recargada en los mismos tiempos k; y al final lo diviremos entre 100 para tener un valor comparativvo per cápita.

$$U_{k}=(\actsymb[k]{\mathit{FT}}{}-\Vx[k]{`r xEdad`: \angl{`r n`}})/100$$
...
Solo para ilustrar este efecto mostraremos el cambio de la mortalidad con la siguiente gráfica, el cual es lineal y terminó de desarrollar más pérdidas que utilidades:
