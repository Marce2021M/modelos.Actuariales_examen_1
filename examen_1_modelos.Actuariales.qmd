...
gastosExtrasPrimas <- function(anio, tipoGasto, primaEmision){
  if(anio == 0){
...
gastosExtrasLiquidacion <- function(anio, tipoGasto, primaEmision){
  if(anio == 0 and tipoGasto == "prima"){
    return(1000 + primaEmision*.4)
  }else if(anio %in% c(1,2) and tipoGasto == "prima"){
    return(500+.2*primaEmision)
  }else if(anio >=3 and tipoGasto == "prima"){
    return(100 + .05*primaEmision)
  }else if(tipoGasto == "liquidacion"){
    return(3000, )
  }
}
